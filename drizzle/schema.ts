...
export const notifications = mysqlTable("notifications", {
  id: int("id").autoincrement().primaryKey(),
  profileId: int("profileId"),
  category: mysqlEnum("category", ["trainee_due_soon", "task_due", "delay_alert", "access_request", "support_ticket", "attendance_confirmation", "security_alert", "performance_recommendation", "chat_message", "report_review", "correspondence_update", "hr_notice"]).notNull(),
  title: varchar("title", { length: 255 }).notNull(),
  body: text("body").notNull(),
...
export const attendanceRecords = mysqlTable("attendance_records", {
  ...
  earlyLeaveDeficitMinutes: int("earlyLeaveDeficitMinutes").default(0).notNull(),
  note: text("note"),
  createdByUserId: int("createdByUserId"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
...
export const leaveRequests = mysqlTable("leave_requests", {
  ...
  requiresSecretaryReview: boolean("requiresSecretaryReview").default(false).notNull(),
...
export const scheduledJobConfigs = mysqlTable("scheduled_job_configs", {
  ...
  attendanceTargetUnitIds: varchar("attendanceTargetUnitIds", { length: 500 }).default("").notNull(),
