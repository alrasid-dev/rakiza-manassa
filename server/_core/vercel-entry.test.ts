...
describe("مسار تشغيل Vercel", () => {
  it("لا يستورد مجلد server/ ولا يسحب Vite إلى دالة النشر", () => {
    ...
    expect(apiEntry).toMatch(/from ["']\.\/handler\.js["']/);
    ...
    for (const source of [apiEntry, handlerEntry, serverEntry, appEntry, staticEntry]) {
